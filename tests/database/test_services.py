...
class TestWarningService:
    ...
    def test_add_warning(self):
        ...
        db_warning = self.service.db.query(SecureWarning).filter(
            SecureWarning.id == warning.id
        ).first()
    ...
    def test_get_user_warnings(self):
        ...
        warning1 = self.service.add_warning(guild_id, user_id, moderator_id, "First warning")
        warning2 = self.service.add_warning(guild_id, user_id, moderator_id, "Second warning")
    ...
    def test_get_user_warnings_exclude_deleted(self):
        ...
        # Add warnings
        warning1 = self.service.add_warning(guild_id, user_id, moderator_id, "Active warning")
        warning2 = self.service.add_warning(guild_id, user_id, moderator_id, "To be deleted")
        ...
        all_warnings = self.service.get_user_warnings(guild_id, user_id, include_deleted=True)
    ...
    def test_export_user_data(self):
        ...
        # Add some data
        warning = self.service.add_warning(guild_id, user_id, moderator_id, "Test warning")
    ...
    def test_delete_user_data(self):
        ...
        # Add some data
        warning1 = self.service.add_warning(guild_id, user_id, moderator_id, "Warning 1")
        warning2 = self.service.add_warning(guild_id, user_id, moderator_id, "Warning 2")
